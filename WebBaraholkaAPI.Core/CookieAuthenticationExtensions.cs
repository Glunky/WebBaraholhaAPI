...
namespace WebBaraholkaAPI.Core;

public static class CookieAuthenticationExtensions
{
    // TODO: что тут происходит?)
    public static void DisableRedirectForPath(this CookieAuthenticationEvents events,
        Expression<Func<CookieAuthenticationEvents, Func<RedirectContext<CookieAuthenticationOptions>, Task>>> expr, string path, int statusCode)
    {
